...
Public Class ShipImageDialog
    ...
    Private Sub ShipImageDialog_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Me.ShipsTableAdapter.FillByImageID(Me.SpaceshipDataSet.Ships, Me.ImageIDComboBox.SelectedValue)
    ...
    Private Sub bAddImage_Click(sender As Object, e As EventArgs) Handles bAddImage.Click
        ...
        If ofd.ShowDialog() = DialogResult.OK Then
            ShipImagePictureBox.Image = Image.FromFile(ofd.FileName)
        End If
    End Sub

    Private Sub bRemoveImage_Click(sender As Object, e As EventArgs) Handles bRemoveImage.Click
        ShipImagePictureBox.Image = Nothing
    End Sub

    Private Sub ShipImagesBindingNavigatorSaveItem_Click_1(sender As Object, e As EventArgs)
        Me.Validate()
        Me.ShipImagesBindingSource.EndEdit()
        Me.TableAdapterManager.UpdateAll(Me.SpaceshipDataSet)
    ...
    Private Sub ShipImagesBindingNavigatorSaveItem_Click_2(sender As Object, e As EventArgs) Handles ShipImagesBindingNavigatorSaveItem.Click
        Me.Validate()
        Me.ShipImagesBindingSource.EndEdit()
        Me.TableAdapterManager.UpdateAll(Me.SpaceshipDataSet)
